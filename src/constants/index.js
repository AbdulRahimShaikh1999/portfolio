...
const experiences = [
  {
    ...
    points: [
      "Collaborated with senior DevOps engineer to establish foundational AWS infrastructure, improving scalability and operational reliability for the Canadian application of the sales process.",
