...
const experiences = [
  {
    ...
    points: [
      ...
      "Improved release stability by ~ 30% by building and optimizing GitHub Actions CI/CD pipelines defined through YAML manifests, integrating build runners and automated testing workflows.",
  ...
  },
  {
    ...
    points: [
      "Spearheaded the digital transition of business operations, introducing cloud-based tools for sales tracking and customer management to improve efficiency and reduce manual errors.",
      "Developed lightweight automation workflows using Python scripts and Google Sheets API for lead tracking, enhancing data accuracy and saving several hours weekly",
      "Integrated internal documentation and CRM processes with cloud platforms (Google Workspace, Notion), streamlining collaboration and onboarding for new staff.",
      "Analyzed customer interaction data to identify service bottlenecks and implemented feedback loops, improving client retention.",
    ],
  },
  {
